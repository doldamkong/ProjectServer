package com.example.a60029513.helloworld;
...
public class WebViewActivity extends AppCompatActivity {
  ...
  //  private static final String HOME_URL = "http://172.16.1.248:52273/req/login";
    private static final String SIGNUP_URL = "http://10.0.2.2:9000/#!/signup";
    private static final String LIST_URL = "http://10.0.2.2:9000/#!/task/list";
    ...
    class MyWebViewClient extends WebViewClient {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            ...
            if (urls.length > 2 && urls[1].equals("detail")) {
                ...
                final View loginView = layoutInflater.inflate(R.layout.activity_login, null);
                ...
                loginDialog.setPositiveButton("Admin", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        TextView idText = (TextView)loginView.findViewById(R.id.user_id);
                        TextView passwordText = (TextView)loginView.findViewById(R.id.password);
                        Toast.makeText(WebViewActivity.this, idText.getText(), Toast.LENGTH_LONG).show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (pref.getString("token", "").equals("")) {
            Intent intent = new Intent(WebViewActivity.this, LoginActivity2.class);
        ...
        protected void onPostExecute(String s) {//s-->서버에서 받은 JSON문자열
            ...
            try {//JSON 파싱 {result:true, token:"asdklsajkj123uasoasduosusadouiss"}
                ...
                if (json.getBoolean("result") == true) {//로그인 성공
                    ...
                    webView.loadUrl("http://172.16.1.248:52273/user/login");
